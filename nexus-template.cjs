...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Refugee Services Intake and Case Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "RefugeeCase";
process.env.TABLE_NAME = process.env.TABLE_NAME || "refugeecase_records";
'use strict';
